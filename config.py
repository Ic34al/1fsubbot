...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "40")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002374692295"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5254177746"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5254177746").split()):
        ADMINS.append(int(x))
except ValueError:
